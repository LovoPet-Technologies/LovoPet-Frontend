...
const founders = [
  { id: 1, name: "Saheli Ghosh Roy", role: "CEO & Founder", color: "#5C2A73" },
  { id: 2, name: "Soumili Das", role: "Co-Founder", color: "#E86A33" },
];
...
const testimonials = [
  ...
  },
  {
    ...
    role: "Farm Owner",
    review:
      "I manage a small poultry farm, and having a vet just a call away for the whole flock has been a relief more than once.",
    color: "#E86A33",
  },
  {
    id: 6,
    ...
    role: "Rabbit Parent",
    review:
      "Finding specialised care for an exotic pet used to be a nightmare. LovoPet connected me with the right vet in minutes.",
    color: "#8B9A5B",
  },
];
...
function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="scroll-mt-16 overflow-hidden bg-[#FDF8F2] pt-16 lg:pt-20"
    >
      <div className="relative mx-auto max-w-6xl px-6 md:px-10 lg:px-14 xl:max-w-7xl xl:px-16">
        {/* Meet the founders */}

        {/* Heading */}
        <div className="mx-auto mt-16 max-w-2xl text-center xl:max-w-3xl">
          ...
          <p className="mt-2 text-base leading-7 text-gray-600 lg:text-lg lg:leading-8">
            Hear from owners and caretakers who found convenient, reliable, and
        ...
        <div className="relative mt-10 lg:mt-12">
          ...
          >
            {testimonials.map((testimonial) => (
              ...
              >
                <Quote size={28} style={{ color: testimonial.color }} />
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div
                    className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-base font-bold text-white lg:h-12 lg:w-12 lg:text-lg"
